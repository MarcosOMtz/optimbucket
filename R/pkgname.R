...
#' special values. You can also transform the variables to the new bucketing's
...
#' are many variables. For a step-to-step example, type \code{browseVignettes(package = "optimbucket")} in the console. For a list of all the functions available, type \code{help(package = optimbucket)} in the console.
#'
#' Enjoy!
"_PACKAGE"
